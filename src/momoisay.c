...
static int randint(const int arr[], int size) { return arr[rand() % size]; }
...
static void construct_v1(const char **art[], char *argv[], int *intervals,
                         int frames, int x, int y, int ry, int length,
                         int lines, int start, int end, int round) {
  int current_frame = 0;
  while (round != 0) {
    nodelay(stdscr, TRUE);
    int ch = getch();
...
static void construct_v2(const char **art[], char *argv[], int *intervals,
                         int frames, int x, int y, int ry, int length,
                         int lines, int start, int end, int reped, int repmin,
                         int repmax, int round) {
...
static void construct_freestyle(char *argv[], int length, int lines, int start,
                                int end) {
...
int main(int argc, char *argv[]) {
  ...
  while ((option = getopt_long(argc, argv, "hvla::s::f::", long_options,
                               NULL)) != -1) {
    switch (option) {
    case 'h':
      help();
